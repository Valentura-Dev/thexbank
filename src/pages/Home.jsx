  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="mt-16 w-full px-9">
        <button className=" bg-dangerous-700 w-full rounded-[10px] py-[17px]">
          <h4 className="font-bold text-secondary-700">Complete Your KVC</h4>
        </button>
      </div>
            ...
            <div key={index} className="flex flex-col gap-[10px]">
              <div className="pl-[47px] flex items-center gap-[21px]">
                ...
                <div className="flex flex-col">
                  <h5>Balance: {item.balance} {item.short}</h5>
